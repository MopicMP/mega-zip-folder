...
> Mega zip/unzip folders in one line

[![PyPI version](https://badge.fury.io/py/mega-zip-folder.svg)](https://pypi.org/project/mega-zip-folder/)
...
result = folder("Hello World")

# Example 2: Batch processing
from mega_zip_folder import batch
